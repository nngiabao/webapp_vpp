    ...
    <body>
        ...
        <div class="container-fluid pt-5">
            <div class="text-center mb-4">
                <h1 class="section-title px-5"><span class="px-2">Product</span></h1>
            </div>
            <form id="pagenav" action="<c:url value='/index'/>" method="post">
                ...
                <c:if test="${search_msg != null}">
                    <input type="hidden" value="${search_msg}" id="search_msg" name="search_msg">
